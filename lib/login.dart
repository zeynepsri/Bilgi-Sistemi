                ...
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    String username = _usernameController.text;
                     ...
                     if (username == 'Öğrenci' || username == 'Ogrenci' || username == 'ogrenci' || username == 'öğrenci' || username == 'Ögrenci' ) {
                        Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => StudentPage()),
                        );
                    } else if (username == 'Öğretmen'|| username == 'Ogretmen' || username == 'ogretmen' || username == 'öğretmen' || username == 'Oğretmen') {
                        Navigator.push(
                        context,
                        MaterialPageRoute(builder: (context) => TeacherPage()),
                       );
                    } else if (username == 'Sekreter'|| username == 'sekreter' ) {
                        Navigator.push(
                        context,
